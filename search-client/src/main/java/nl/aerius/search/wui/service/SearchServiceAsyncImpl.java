...
public class SearchServiceAsyncImpl implements SearchServiceAsync {
  ...
  @Override
  public void startSearchQuery(final String query, final Set<SearchCapability> capabilities, final String region, final String cancel, final AsyncCallback<SearchResult> callback) {
